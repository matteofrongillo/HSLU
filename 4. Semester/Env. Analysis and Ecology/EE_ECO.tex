...
\subsubsection{Manufactured (industrial) capital}
Manufactured capital includes human-made physical assets used in
production processes. Examples include machinery, equipment,
factories, buildings, infrastructure, and technological systems that
...
\subsubsection{Problems with env. economics}
\paragraph{Scarcity}
\begin{itemize}
