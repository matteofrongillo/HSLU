...
\begin{center}
    \begin{tikzpicture}[scale=1.25]
        \begin{axis}[
          ...
          \node[right] at (-8.7,-5.25) {\footnotesize {\color{green!30}{$\blacksquare$}} Positive area};
          \node[right] at (-8.7,-6.25) {\footnotesize {\color{red!30}{$\blacksquare$}} Negative area};
          \draw (-8.7,-4.75) rectangle (-2.5,-6.75);
