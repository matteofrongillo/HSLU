...
In a very small neighborhood of a point $a$, we can assume that the
function in that point is linear.
...
The error of the approximation is given by the substraction between
the exact function and the linearization:
\figbox{$E(x) = f(x)-f(a)-f'(a)\cdot(x-a)$}
