...
\subsubsection{Drag on a body in a flow}
\figbox{$\dm F_D = F_P + F_\tau$}
...
\subsubsection{Drag power}
\figbox{$P_D = F_D v_\infty$}
...
\figbox{$F_D \approx F_\tau = 3\pi\eta dv_\infty$}
