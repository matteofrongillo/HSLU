...
\titlespacing*{\paragraph}{0pt}{6pt}{1pt}
...
\titleformat{\paragraph}{\small\bfseries}{\theparagraph}{0em}{}
...
\end{center}
\figbox{$\dm \dot{E}_L = T_E \dot{S}_{\mathrm{irr}} = T_E\ \dot{m}\left(s_2 - s_1\right) = T_E \underbrace{\frac{\Delta T}{T_1\cdot T_2}\,\dot{Q}}_{\dot{S}_{\mathrm{irr}}}$}
...
\begin{gather*}
  e = h - h_E - T_E\left(s-s_E\right) + \dfrac{c^2}{2} + gz + q\left(1-\dfrac{T_E}{T}\right)\\
