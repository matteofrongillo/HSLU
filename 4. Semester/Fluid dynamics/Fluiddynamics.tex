...
\begin{enumerate}[label=Step \arabic*.]
  ...
  \item Repeating variables: $D, v_\infty, \rho$\\[0ex]
  \item Number of $\Pi$-groups: $n-r = 5-3 = 2$\\[0.5ex]
        $\dm \Pi_1 = F_D D^{a_1} v_\infty^{b_1} \rho^{c_1}\quad ; \quad \Pi_2 = F_D D^{a_2} v_\infty^{b_2} \rho^{c_3}$
\end{enumerate}
