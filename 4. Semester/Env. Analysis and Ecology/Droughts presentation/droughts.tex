...
\vspace*{-.7cm}
\section*{The Dust Bowl event {\footnotesize(Leo)}}
...
\section*{Droughts from the past to the present {\footnotesize(Elisa)}}
...
\section*{Future droughts scenarios {\footnotesize(David)}}
...
\section*{Mixed-grass prairies after the Dust Bowl {\footnotesize(Matteo)}}
...
\section*{Casual Loop Diagram (CLD) of drought in prairie ecosystems\\{\footnotesize(Matteo, David)}}
\begin{figure}[H]
    \centering
