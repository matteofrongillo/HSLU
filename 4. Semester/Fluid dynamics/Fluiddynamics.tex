...
\newcolumn
\section{Superposition of inviscid flows}
\subsection{Superposition principle}
Laplace equation (potential flow) is linear, therefore
...
\subsection{Piecewise modelling approach}
...
& $\displaystyle p(r) = p_0 + \frac{1}{2}\rho\Omega^2 r^2$
...
\begin{tcolorbox}[colback=notebg, colframe=noteborder, boxrule=0.8pt, arc=3pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt]
\small All these flows are solutions of Laplace's equation $(\nabla^2\Phi=0)$ and can be combined by superposition. They serve as building blocks for more complex potential flows.
\end{tcolorbox}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.45\textwidth}
\begin{tcolorbox}[colback=white, colframe=black!40, boxrule=0.7pt, arc=2pt,
  left=5pt, right=5pt, top=3pt, bottom=3pt]
\textbf{\small Notation}\\[3pt]
\begin{tabular}{@{}ll|@{\quad}ll@{}}
$r$ & radial distance & $C_\varphi$ & vortex strength (constant)\\
$\varphi$ & azimuthal angle & $C_r$ & source strength ($>0$) or\\
$v_r$ & radial velocity component & & sink strength ($<0$)\\
$v_\varphi$ & tangential (azimuthal) vel.\ comp. & $\Omega$ & angular velocity (rigid-body vortex)\\
