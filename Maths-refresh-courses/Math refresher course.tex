...
\begin{itemize}
    ...
    \item $m<0$, the line si decreasing. 
\end{itemize}
...
The more the value of m increase, the closer the line vertical will be, but
never getting vertical.
...
\figbox{$V=\left(-\frac{b}{2a},\ -\frac{\Delta}{2a}\right)$}
...
$V=\left(-\frac{0}{2},\ -\frac{0}{2}\right) \rightarrow V(0,0)$
...
Let $a,c \in \mathbb{Z}$,\ $b,c \in \mathbb{Z}^*$ and $\lambda \in \mathbb{R} \difference \mathbb{Z}$. Then, we can approssimate $\lambda$
by a fraction:
