...
% === TEXT ===
\title{\textbf{SContext 1\\ HSLU, Semester 1}}
...
\begin{tikzpicture}
    ...
    \node[above] at (1.5,4.1) {\large \textbf{CEO}: Simon Althaus};
    ...
    \node[below] at (-6,-5) {\large \textbf{Co-worker}: xxx xxx};

    \draw[thick] (-2.5,-2) rectangle (0.5,-5);
    \node[below] at (-1,-5) {\large \textbf{Co-worker}: xxx xxx};

    \draw[thick] (2.5,-2) rectangle (5.5,-5);
    \node[below] at (4,-5) {\large \textbf{Co-worker}: xxx xxx};

    \draw[thick] (7.5,-2) rectangle (10.5,-5);
    \node[below] at (9,-5) {\large \textbf{Co-worker}: xxx xxx};
\end{tikzpicture}
