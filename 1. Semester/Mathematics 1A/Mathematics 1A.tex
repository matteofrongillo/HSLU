...
\subsubsection{Definition of monotonicity}
...
We define $y=f^{(n)}(x)$ as the derivate of $y=f^{(n-1)}(x)$.

\rem{Derivates will be written with the Lagrange's notation and roman numbers, i.g.: $f''''(x) \to f^{\rom{4}}(x)$}
