...
Let $f(z)$ be a derivable function. To compute the derivative of the
integral between $a(z)$ and $b(z)$ of $f(t)$, we can use the Leibniz
integral rule:
\figbox{$\dm \frac{d}{dz} \integral[a(z)][b(z)][f(t)][t] = f(b(z)) \cdot b'(z) - f(a(z) \cdot a'(z))$}
