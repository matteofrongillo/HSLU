...
\section{\color{red}{TO CHECK Equations and inequalities with absolute values}}
...
\figbox{$
    \begin{cases}
        ...
        \text{case 2: } -x-a=-x+b \Rightarrow  \Rightarrow x_2=\frac{b-a}{2}
...
\textbf{\color{red}Write all steps}

When the sum of the coefficients is equal to 0, then the polynomial is always divisible
by $x-1$.
...
The three possible outputs we can have solving this 2nd-degree polynomial are:
\begin{itemize}
    \item 2 solutions;
    \item 1 solution;
    \item 0 solutions.
...
From the discriminant we can count how many solutions the equation will have:
\begin{itemize}
...
When we have a 2nd grade equation $(x-a)(x-b)=0$, we have two evident solutions
in $\mathbb{R}$. In this case, $x_1=a,\ x_2=b$ 

This factorization can be reached with notable products.
