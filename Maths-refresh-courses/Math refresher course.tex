...
\section{Polynomials with $\deg=2$}
Let $a,b,c \in \mathbb{R}$, then
\figbox{$ax^2+bx+c=0$}

The three possible outputs we can have solving this 2nd grade polynomial are:
\begin{itemize}
    \item 2 solutions;
    \item 1 solution;
    \item 0 solutions.
...
Delta: $\Delta=\sqrt{b^2-4ac}$
\figbox{$x_{1,2}=\frac{-b \mp \Delta}{2a}$}
